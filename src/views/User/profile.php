          ...
          <div class='card p-4'>
            <div class='image d-flex flex-column justify-content-center align-items-center'>
              <button class='btn btn-secondary'>
                <img src='<?= $gravitar ?>' height='100' width='100' />
              </button>
              ...
              <div class='d-flex mt-2'>
                <button href='#apiField' class='btn btn-dark' data-toggle='collapse'>Toggle API Key</button>
              </div>
              <div class='d-flex mt-2'>
                <span id='apiField' class='collapse'>
                  <p><?= $apiKey ?></h3>
                </span>
              </div>
